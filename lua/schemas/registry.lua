return {
  ...
  { name = "chrome-extension", description = "Chrome Extension", url = "https://json.schemastore.org/chrome-manifest", json = { "manifest.json" } },
  ...
  { name = "kustomization", description = "Kubernetes native configuration management", url = "https://www.schemastore.org/kustomization.json", yaml = { "kustomization.yaml", "kustomization.yml" } },
