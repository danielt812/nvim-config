...
-- VM-like “skip next/prev”
-- vim.keymap.set({ "n", "x" }, "<C-x>", function() multicursor.matchSkipCursor(1) end)
-- vim.keymap.set({ "n", "x" }, "<M-x>", function() multicursor.matchSkipCursor(-1) end) -- optional
