return {
  {
    ...
    opts = function()
      return {
        ...
        mappings = {
          ["."] = { "<cmd>lua vim.lsp.buf.format()<CR>", "Format File 󰘞 " },
          ...
          d = {
            ...
            -- ["C"] = { "<cmd>lua require('dap').run_to_cursor()<CR>", "Run To Cursor 󰆿 " },
          ...
          l = {
            ...
            i = {
              ...
              ["m"] = { "<cmd>Mason<CR>", "Mason 󰢛 " },
              ["t"] = { "<cmd>TSModuleInfo<CR>", "Treesitter 󱖫 " },
              ["n"] = { "<cmd>NullLsInfo<CR>", "Null-LS 󱆨 " },
            },
            f = {
              name = "+Find   ",
              ...
              ["u"] = { "<cmd>Telescope lsp_document_symbols<CR>", "Document Symbols 󱪚 " },
              ["w"] = {
          ...
          r = {
            name = "+Replace 󰛔 ",
            ["f"] = { "<cmd>lua require('spectre').open_file_search()<CR>", "File 󰱽 " },
            ["s"] = { "<cmd>lua require('spectre').open()<CR>", "Spectre 󱙝 " },
            ["w"] = { "<cmd>lua require('spectre').open_visual({select_word=true})<CR>", "Word 󱩾 " },
          },
          t = {
            name = "+Toggle 󰨚  ",
            ["d"] = { "<cmd>lua require('dapui').toggle({reset = true})<CR>", "DAP  " },
            ["e"] = { "<cmd>NvimTreeToggle<CR>", "Explorer 󰙅 " },
            ["h"] = { "<cmd>ToggleHighlight<CR>", "Highlight 󰌁 " },
            ["l"] = { "<cmd>ToggleSpell<CR>", "Spell 󰓆 " },
            ["r"] = { "<cmd>ToggleRelative<CR>", "Relative  " },
            ["s"] = { "<cmd>Spectre<CR>", "Spectre 󱙝 " },
            ["t"] = { "<cmd>Trouble<CR>", "Trouble  " },
            ["w"] = { "<cmd>ToggleWrap<CR>", "Wrap 󰖶 " },
            ["i"] = { "<cmd>Twilight<CR>", "Twilight 󰖚 " },
