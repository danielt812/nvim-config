...
-- Undo / Redo --------------------------------------------------------------------
local function on_undo_redo(from_hl, to_hl, effect)
  ...
  -- Keymap Wrappers ----------------------------------------------------------------
  -- stylua: ignore start
  local function on_undo() vim.schedule(on_undo_redo("OnUndo", "Normal")) end
  local function on_redo() vim.schedule(on_undo_redo("OnRedo", "Normal")) end
