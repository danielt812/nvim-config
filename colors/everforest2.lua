...
local highlights = {
  ...
  MiniHiPatternsTodo = syntax_entry(palette.bg0, "#ff8c00"),
  MiniHiPatternsFixme = syntax_entry(palette.bg0, "#98c379"),
  ...
  MiniStatuslineDiffAdd = syntax_entry(palette.green, palette.bg2),
  MiniStatuslineDiffChange = syntax_entry(palette.blue, palette.bg2),
  MiniStatuslineDiffDelete = syntax_entry(palette.red, palette.bg2),
  ...
  MiniNotifyLspProgress = syntax_entry(palette.blue, palette.none),
