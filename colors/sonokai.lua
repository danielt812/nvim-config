...
local highlights = {
  ...
  Terminal = { fg = palette.white, bg = palette.bg_dim }, -- NOTE: CUSTOM
  -- stylua: ignore end
  ...
  -- stylua: ignore start
  Comment        = { fg = palette.grey0, italic = true },
  SpecialComment = { fg = palette.grey0, italic = true },
  -- stylua: ignore end
  ...
  TSProperty             = { link = "Orange" },
  TSPunctBracket         = { link = "Grey" },
