...
-- stylua: ignore start
  ...
  CursorLineNr = { fg   = palette.fg,   bg = palette.bg0 },
  ...
  -- stylua: ignore start
  Boolean      = { link = "Magenta" },
  Character    = { link = "Green" },
  Conditional  = { link = "Magenta" },
  Constant     = { link = "Cyan" },
  Define       = { link = "Magenta" },
  Error        = { link = "Red" },
  Exception    = { link = "Red" },
  Float        = { link = "Magenta" },
  Function     = { link = "Yellow" },
  Identifier   = { link = "Blue" },
  Include      = { link = "Magenta" },
  Keyword      = { link = "Red" },
  Label        = { link = "Orange" },
  Macro        = { link = "Cyan" },
  Number       = { link = "Magenta" },
  Operator     = { link = "White" },
  PreCondit    = { link = "Magenta" },
  PreProc      = { link = "Magenta" },
  Repeat       = { link = "Red" },
  Special      = { link = "Yellow" },
  ...
  White   = { fg = palette.fg,      bg = palette.none },
  ...
  TSFunction             = { link = "Yellow" },
  TSFunctionCall         = { link = "Yellow" },
  TSInclude              = { link = "Red" },
  TSKeyword              = { link = "Blue" },
  TSKeywordFunction      = { link = "Magenta" },
  TSKeywordOperator      = { link = "White" },
  TSKeywordReturn        = { link = "Red" },
  TSLabel                = { link = "Orange" },
  TSLiteral              = { link = "String" },
  TSMath                 = { link = "Blue" },
  TSMethod               = { link = "Green" },
  TSMethodCall           = { link = "Yellow" },
  TSModuleInfoGood       = { link = "Green" },
  TSModuleInfoBad        = { link = "Red" },
  TSNamespace            = { link = "Yellow" },
  TSNone                 = { link = "Fg" },
  TSNumber               = { link = "Magenta" },
  TSOperator             = { link = "White" },
  TSParameter            = { link = "Cyan" },
  TSParameterReference   = { link = "Fg" },
  TSPreProc              = { link = "PreProc" },
  TSProperty             = { link = "Cyan" },
