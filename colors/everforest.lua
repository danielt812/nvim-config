...
local highlights = {
  ...
  FoldColumn   = { fg = palette.bg5,  bg = palette.bg1 },
  SignColumn   = { fg = palette.fg,   bg = palette.bg1 },
  -- stylua: ignore end

-- stylua: ignore start
  Cursor       = { fg   = palette.none,  bg = palette.none, reverse = true },
  lCursor      = { fg   = palette.none,  bg = palette.none, reverse = true },
  CursorLineNr = { fg   = palette.grey1, bg = palette.bg1 },
  ...
  YellowItalic = { fg = palette.yellow, bg = palette.none, italic = true },
  GreenItalic  = { fg = palette.green,  bg = palette.none, italic = true },
  AquaItalic   = { fg = palette.aqua,   bg = palette.none, italic = true },
  BlueItalic   = { fg = palette.blue,   bg = palette.none, italic = true },
  PurpleItalic = { fg = palette.purple, bg = palette.none, italic = true },
  -- stylua: ignore end

  -- stylua: ignore start
  RedBold    = { fg = palette.red,    bg = palette.none, bold = true },
  OrangeBold = { fg = palette.orange, bg = palette.none, bold = true },
  YellowBold = { fg = palette.yellow, bg = palette.none, bold = true },
  GreenBold  = { fg = palette.green,  bg = palette.none, bold = true },
  AquaBold   = { fg = palette.aqua,   bg = palette.none, bold = true },
  BlueBold   = { fg = palette.blue,   bg = palette.none, bold = true },
  PurpleBold = { fg = palette.purple, bg = palette.none, bold = true },
  -- stylua: ignore end
  ...
  AquaSign   = { fg = palette.aqua,   bg = palette.bg1 },
  ...
  -- SmiteshP/nvim-navic
  -- stylua: ignore start
  NavicIconsFile          = { fg = palette.fg,     bg = palette.none },
  NavicIconsModule        = { fg = palette.yellow, bg = palette.none },
  NavicIconsNamespace     = { fg = palette.fg,     bg = palette.none },
  NavicIconsPackage       = { fg = palette.fg,     bg = palette.none },
  NavicIconsClass         = { fg = palette.orange, bg = palette.none },
  NavicIconsMethod        = { fg = palette.blue,   bg = palette.none },
  NavicIconsProperty      = { fg = palette.green,  bg = palette.none },
  NavicIconsField         = { fg = palette.green,  bg = palette.none },
  NavicIconsConstructor   = { fg = palette.orange, bg = palette.none },
  NavicIconsEnum          = { fg = palette.orange, bg = palette.none },
  NavicIconsInterface     = { fg = palette.orange, bg = palette.none },
  NavicIconsFunction      = { fg = palette.blue,   bg = palette.none },
  NavicIconsVariable      = { fg = palette.purple, bg = palette.none },
  NavicIconsConstant      = { fg = palette.purple, bg = palette.none },
  NavicIconsString        = { fg = palette.green,  bg = palette.none },
  NavicIconsNumber        = { fg = palette.orange, bg = palette.none },
  NavicIconsBoolean       = { fg = palette.orange, bg = palette.none },
  NavicIconsArray         = { fg = palette.orange, bg = palette.none },
  NavicIconsObject        = { fg = palette.orange, bg = palette.none },
  NavicIconsKey           = { fg = palette.purple, bg = palette.none },
  NavicIconsKeyword       = { fg = palette.purple, bg = palette.none },
  NavicIconsNull          = { fg = palette.orange, bg = palette.none },
  NavicIconsEnumMember    = { fg = palette.green,  bg = palette.none },
  NavicIconsStruct        = { fg = palette.orange, bg = palette.none },
  NavicIconsEvent         = { fg = palette.orange, bg = palette.none },
  NavicIconsOperator      = { fg = palette.fg,     bg = palette.none },
  NavicIconsTypeParameter = { fg = palette.green,  bg = palette.none },
  NavicText               = { fg = palette.fg,     bg = palette.none },
  NavicSeparator          = { fg = palette.fg,     bg = palette.none },
  -- stylua: ignore end
  ...
  MiniHiPatternsWarn = { fg = palette.bg0, bg = "#ff2d00" },
  MiniHiPatternsFixme = { fg = palette.bg0, bg = "#ff8c00" },
  MiniHiPatternsTodo = { fg = palette.bg0, bg = "#98c379" },
  MiniHiPatternsHack = { fg = palette.bg0, bg = "#d699b6" },
  MiniHiPatternsNote = { fg = palette.bg0, bg = "#3498db" },
  ...
  MiniStatuslineDiffAdd     = { fg = palette.green,  bg = palette.bg2 },
  MiniStatuslineDiffChange  = { fg = palette.blue,   bg = palette.bg2 },
  MiniStatuslineDiffDelete  = { fg = palette.red,    bg = palette.bg2 },
  ...
  NeotestFocused = { link = "YellowSign" },
  NeotestFile = { link = "Aqua" },
  NeotestDir = { link = "Directory" },
  NeotestBorder = { link = "BlueSign" },
